...
class ServicioTask        //constructor del hilo (Asynctask)
(//variables del hilo
    ...
    init {
        ...
        this.email= "esteesotrocommit@fernando.com"
    ...
    /*
    class ServicioTask (ctx: Context, linkAPI: String, name: String, last_name: String, user_name: String, email:String, password:String, gender:String, birthdate:String){
        this.linkrequestAPI = linkAPI
        this.name = name
        this.last_name = last_name
        this.user_name = user_name
