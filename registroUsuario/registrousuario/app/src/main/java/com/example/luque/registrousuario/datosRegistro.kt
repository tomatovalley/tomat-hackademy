...
fun consumirServicio(){
    val ServicioTask = ServicioTask(httpContext = this,linkAPI = "http://192.168.1.68:3000/users/signup", name=this.name, last_name=this.last_name, user_name=this.user_name, email=this.email, password=this.password, birthdate="1997-07-20T00:00:00.000Z",gender=this.gender)
